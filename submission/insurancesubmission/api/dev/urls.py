...
urlpatterns = [
    ...
    path('sign/document/call/', api_views.CallDocumentToken.as_view()),

    # POST - Get a token's current progress (customer)
    path('sign/document/progress/', api_views.ProgressReportView.as_view()),
    ...
    path('sign/document/<int:pk>/payment/', api_views.AddPaymentData.as_view()),
